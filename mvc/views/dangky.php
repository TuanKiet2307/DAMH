          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="<?php echo xulydangky; ?>" method="POST">
                ...
                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cg" class="form-control form-control-lg" name="matkhau"/>
                  <label class="form-label" for="form3Example4cg">Password</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cdg" class="form-control form-control-lg" name="nhaplaimatkhau"/>
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="<?php echo dangnhap?>"
